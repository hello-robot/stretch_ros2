...
class FrustumNode(Node):
    ...
    def camera_info_callback(self, camera_info, camera_type=None):
        ...
        duration = Duration(seconds=0.5) #0.2
    ...
    def main(self):
        ...
        self.depth_camera_info_subscriber = self.create_subscription(CameraInfo, self.depth_camera_topic, self.depth_camera_info_callback)
        self.color_camera_info_subscriber = self.create_subscription(CameraInfo, self.color_camera_topic, self.color_camera_info_callback)

        self.depth_frustum_marker_pub = self.create_publisher(Marker, '/frustum_marker/depth_camera', queue_size=1)
        self.color_frustum_marker_pub = self.create_publisher(Marker, '/frustum_marker/color_camera', queue_size=1)
