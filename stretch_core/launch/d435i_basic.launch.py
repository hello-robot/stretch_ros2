...
configurable_parameters = [{'name': 'json_file_path',               'default': json_path, 'description': 'allows advanced configuration'},
                           {'name': 'depth_module.profile',         'default': '0,0,15.0', 'description': 'depth module profile'},                           
                           {'name': 'enable_depth',                 'default': 'true', 'description': 'enable depth stream'},
                           {'name': 'rgb_camera.profile',           'default': '0,0,15.0', 'description': 'color image width'},
                           ...
                           {'name': 'accel_fps',                    'default': '63.0', 'description': "''"},                           
