// This is a test script to demonstrate the Hybrid Planning capability of MoveIt 2 with the Stretch RE1 robot
// It is based on the hybrid planning tutorial for MoveIt 2
...
int main(int argc, char** argv)
{
  ...
  rclcpp::Node::SharedPtr node = std::make_shared<rclcpp::Node>("hybrid_planning_demo_node", "", node_options);
